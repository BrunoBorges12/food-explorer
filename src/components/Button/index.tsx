...
function Button({ title, size, color, mobile, loading }: propsButton) {
  return (
    <button
    ...
    >
      {loading ? (
        ...
        <span className=" ml-1 capitalize text-light-100 text-sm  font-poppins  hover:opacity-80 font-medium">
          {title}
        </span>
      )}
    </button>
